...
<body>
	<jsp:useBean id="project" scope="request" class="vo.Project" type="vo.Project"/>
	...
	<form action='update.do' method='post'>
		...
		<ul>
			...
			<li><label for="tags">태그</label> <input id="tags" type='text'
				...
				value='<%=project.getTags() %>'></li>
		</ul>
		<input type='submit' value='저장'> <input type='button'
			value='삭제' onclick='location.href="delete.do?no='<%=project.getNo() %>'>
